        ...
        <div className="hl-form">
          ...
          {kind === 'symptom' && (
            <details className="hl-sites small">
              ...
              <p className="muted">
                <b>Линии:</b> Ц — по центру живота · ПС — между центром и линией соска · СК —
                вниз от середины ключицы · ПП — передний край подмышки · СП — ровно сбоку,
                «в профиль» · ЗП — задний край подмышки · Лп — сзади под лопаткой.
              </p>
              <p className="muted">
